...
<form method="POST" action="{{route('schedule.store')}}">
    ...
    <div class="form-group">
        ...
        <textarea name="description" id="desc" cols="30" rows="10" placeholder="Description about the project"
    ...
    <div class="form-check">
        <label class="form-check-label"><input class="form-check-input" type="checkbox" value="{{$user->id}}"
                name="users[]">{{$user->name}}</label>
    </div>
    @endforeach
